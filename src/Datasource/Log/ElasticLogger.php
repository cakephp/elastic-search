...
class ElasticLogger extends AbstractLogger
{
     ...
     *
     * @param \Psr\Log\LoggerInterface $logger Instance of the QueryLogger
     ...
     *
     * @param \Psr\Log\LoggerInterface $logger Set logger instance to pass logging data to
     * @return $this
     */
     ...
     *
     * @return \Psr\Log\LoggerInterface [description]
     */
